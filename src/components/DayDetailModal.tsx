      ...
      <DialogContent className="sm:max-w-md border-border bg-card">
        ...
        <div className="space-y-4">
          ...
          {day.isLastTen && !day.isQadrNight && (
            <p className="text-primary font-medium">🌙 Last 10 Nights</p>
          )}

          {day.isDualEidCell && (
            <div className="space-y-1 text-sm">
              <p className="text-primary font-medium">🌙 Eid al-Fitr — if Ramadan is 29 days</p>
              <p className="text-foreground font-medium">or 30th Fast — if Ramadan is 30 days</p>
            </div>
          )}

          {day.isEidIf30 && (
            <p className="text-primary font-medium">🌙 Eid al-Fitr — if Ramadan is 30 days</p>
          )}
